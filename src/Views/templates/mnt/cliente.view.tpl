...
<section class="row">
  ...
  >
    ...
    <section class="row">
      <label for="clientphone1" class="col-4">Teléfono principal</label>
      <input type="text" {{readonly}} name="clientphone1" value="{{clientphone1}}" maxlength="45" placeholder="Dirección telefónica"/>
    ...
    <section class="row">
      <label for="clientphone2" class="col-4">Teléfono alterno</label>
      <input type="text" {{readonly}} name="clientphone2" value="{{clientphone2}}" maxlength="45" placeholder="Teléfono secundario"/>
    ...
    <section class="row">
      ...
      <input type="text" {{readonly}} name="clientemail" value="{{clientemail}}" maxlength="45" placeholder="Correo del cliente"/>
    ...
    <section class="row">
      ...
      <input type="text" {{readonly}} name="clientIdnumber" value="{{clientIdnumber}}" maxlength="45" placeholder="Numero de cédula"/>
